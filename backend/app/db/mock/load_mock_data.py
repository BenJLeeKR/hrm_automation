...
PROJECTS = [
    {"PJT_CD": "PJT-2025-001", "PJT_NM": "차세대 코어뱅킹 구축", "CLNT_NM": "신한은행",
     "PJT_STAT_CD": "RUNNING", "STRT_DT": date(2025, 9, 1), "END_DT": None},
...
ASSIGNMENTS = [
    ...
    (13, "PJT-2025-002", "테스트", 50, date(2025, 11, 1), None, "RUNNING", "ACTIVE"),
    (2, "PJT-2025-003", "아키텍처 설계", 50, date(2025, 10, 15), None, "RUNNING", "ACTIVE"),
    ...
    (18, "PJT-2025-005", "인프라 구축", 100, date(2025, 8, 1), None, "RUNNING", "ACTIVE"),
    (24, "PJT-2025-005", "전환 컨설팅", 50, date(2025, 8, 1), None, "RUNNING", "ACTIVE"),
    (9, "PJT-2026-006", "백엔드 개발", 100, date(2026, 1, 1), None, "RUNNING", "ACTIVE"),
    ...
    (11, "PJT-2025-009", "프론트엔드 개발", 100, date(2025, 12, 15), None, "RUNNING", "ACTIVE"),
    (12, "PJT-2025-009", "백엔드 개발", 100, date(2025, 12, 15), None, "RUNNING", "ACTIVE"),
    (25, "PJT-2025-009", "업무 컨설팅", 100, date(2025, 12, 15), None, "RUNNING", "ACTIVE"),
    (14, "PJT-2026-011", "품질 관리", 100, date(2026, 2, 1), None, "RUNNING", "ACTIVE"),
