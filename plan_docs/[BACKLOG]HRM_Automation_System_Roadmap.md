...
| Phase 4 | Next.js 웹 클라이언트 구축 | 3~5주차 | 진행 중 | 75% | 정상 |
...
- [ ] 1. 가동 가능 인력 조회 화면 구현 (`/availability` — 직무 유형 필터 포함)
- [ ] 2. 리소스 추천 화면 구현 (`/recommendations`, `PJT_RCMD_RSLT`)
- [ ] 3. AI Chat 화면 구현 (`/ai-chat`)
- [ ] 4. 리포트 화면 구현 (`/reports`)
- [ ] 5. 설정 화면 구현 (`/settings/users`, `/settings/audit-logs`)
- [ ] 6. Excel Import/Export UI 구현
